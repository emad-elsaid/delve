...
import (
	...
	"github.com/emad-elsaid/delve/pkg/proc/debuginfod"
...
See $GOPATH/src/github.com/emad-elsaid/delve/Documentation/cli/locspec.md for the syntax of locspec. If locspec is omitted a breakpoint will be set on the current line.
...
A tracepoint is a breakpoint that does not stop the execution of the program, instead when the tracepoint is hit a notification is displayed. See $GOPATH/src/github.com/emad-elsaid/delve/Documentation/cli/locspec.md for the syntax of locspec. If locspec is omitted a tracepoint will be set on the current line.
...
If path ends with the .star extension it will be interpreted as a starlark script. See $GOPATH/src/github.com/emad-elsaid/delve/Documentation/cli/starlark.md for the syntax.
