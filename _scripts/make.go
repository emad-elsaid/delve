...
const DelveMainPackagePath = "github.com/emad-elsaid/delve/cmd/dlv"
...
`,
	...
	integration 	tests github.com/emad-elsaid/delve/service/test
...
func testSetToPackages(testSet string) []string {
	...
	case "basic":
		return []string{"github.com/emad-elsaid/delve/pkg/proc", "github.com/emad-elsaid/delve/service/test", "github.com/emad-elsaid/delve/pkg/terminal"}

	case "integration":
		return []string{"github.com/emad-elsaid/delve/service/test"}
