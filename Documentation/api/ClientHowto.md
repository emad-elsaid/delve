...
Specifying a static port number, like in the [README](//github.com/emad-elsaid/Delve/tree/master/Documentation/README.md) example, can be done using `--listen=127.0.0.1:portnumber`. 
...
The methods of a `service/rpc2.RPCServer` are exposed through this connection, to find out which requests you can send see the documentation of RPCServer on [godoc](https://godoc.org/github.com/emad-elsaid/Delve/service/rpc2#RPCServer). 

### Example

Let's say you are trying to create a breakpoint. By looking at [godoc](https://godoc.org/github.com/emad-elsaid/Delve/service/rpc2#RPCServer) you'll find that there is a `CreateBreakpoint` method in `RPCServer`.
...
If you want to support the [same language as dlv's break and trace commands](//github.com/emad-elsaid/Delve/tree/master/Documentation/cli/locspec.md)
...
can be found [here](//github.com/emad-elsaid/Delve/tree/master/Documentation/cli/expr.md).
